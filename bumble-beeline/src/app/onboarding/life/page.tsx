...
export default function LifePage() {
  ...
  const travelExperiences = lifeExperiences.filter(
    (e) => e.category === "travel",
  );
  const educationExperiences = lifeExperiences.filter(
    (e) => e.category === "education",
  );
  const workingExperiences = lifeExperiences.filter(
    (e) => e.category === "working",
  );
        ...
        <div className="flex-1 px-6 pt-8 overflow-auto hide-scrollbar pb-4">
          ...
          >
            ...
            <p className="text-gray-600 mt-2 text-base leading-relaxed">
              Pick <span className="font-semibold">up to 3</span> to find
              friends with{" "}
              <span className="font-semibold">shared experiences.</span>
            </p>
          </motion.div>
